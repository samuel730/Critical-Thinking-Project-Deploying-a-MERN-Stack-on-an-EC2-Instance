...
This project demonstrates the deployment of a full-stack MERN (MongoDB, Express, React, Node.js) application on an AWS EC2 Ubuntu instance. The purpose of the project was to gain practical experience in cloud computing, server configuration, and full-stack application deployment in a real-world environment.
